...
namespace VoxelPlay {
    ...
    public class VoxelPlayEnvironmentEditor : Editor {
        ...
        static bool expandQualitySection, expandStatsSection, expandVoxelGenerationSection, expandSkySection, expandInGameSection, expandDefaultsSection, expandAdvancedSection;
        ...
        public static void ShowSupport() {
            Application.OpenURL("https://kronnect.com/support/index.php/board,56.0.html");
        }
